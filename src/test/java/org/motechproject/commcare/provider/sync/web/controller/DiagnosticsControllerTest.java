...
public class DiagnosticsControllerTest {
    ...
    public void shouldReturnCompleteLogAsResponse() throws Exception {
        ...
        assertEquals(Arrays.asList("org.motechproject.commcare.provider.sync.constants.sync.group-group",
                "org.motechproject.commcare.provider.sync.constants.sync.provider-provider"),
