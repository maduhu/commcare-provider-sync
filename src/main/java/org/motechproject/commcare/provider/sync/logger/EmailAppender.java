package org.motechproject.commcare.provider.sync.logger;
...
public class EmailAppender extends SMTPAppender {
    ...
    private void addLogEvent(StringBuffer buffer) throws MessagingException, UnsupportedEncodingException {
        for (int i = 0; i < cb.length(); i++) {
            ...
            if (!layout.ignoresThrowable()) continue;
