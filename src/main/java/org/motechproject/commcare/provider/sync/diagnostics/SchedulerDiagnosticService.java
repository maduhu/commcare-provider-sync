...
public class SchedulerDiagnosticService {
    ...
    @Autowired
    public SchedulerDiagnosticService(ApplicationContext applicationContext, @Qualifier("quartzProperties") Properties quartzProperties) throws Exception {
    ...
    public SchedulerDiagnosticService(SchedulerFactoryBean schedulerFactoryBean, List<String> schedules) {
        this.scheduler = schedulerFactoryBean.getScheduler();
        this.schedules = schedules;
    }

    public DiagnosticsResult diagnoseAllSchedules() throws SchedulerException {
